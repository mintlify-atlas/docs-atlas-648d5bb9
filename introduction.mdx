...
description: "Build LiveSplit One auto splitters in AssemblyScript: attach to game processes, read memory, and control the speedrun timer from a .wasm binary."
---
